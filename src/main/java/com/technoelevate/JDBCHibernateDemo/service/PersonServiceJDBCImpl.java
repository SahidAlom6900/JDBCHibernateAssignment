...
import com.technoelevate.JDBCHibernateDemo.dao.PersonDaoJDBCImpl;
import com.technoelevate.JDBCHibernateDemo.dto.Person;

public class PersonServiceJDBCImpl implements PersonServiceInter {
	private PersonDaoInter personDaoInter = new PersonDaoJDBCImpl();
